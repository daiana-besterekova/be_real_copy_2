...
class FeedViewController: UIViewController {
    ...
    @IBOutlet weak var commentTextField: UITextField! // UITextField outlet
    @IBOutlet weak var postButton: UIButton! // UIButton outlet
    @IBOutlet weak var statusLabel: UILabel! // UILabel outlet
    ...
    @IBAction func postComment(_ sender: Any) {
                ...
                guard let commentText = commentTextField.text, !commentText.isEmpty else {
                    statusLabel.text = "Please enter a comment"
                    return
                }

                // Perform actions to post comment
                // Example: You might want to save the comment to your database or display it in the UI.
                
                // Clear the text field after posting comment
                commentTextField.text = ""
                
                // Update status label
                statusLabel.text = "Comment posted successfully"
    }
